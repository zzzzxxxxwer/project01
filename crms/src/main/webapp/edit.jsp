...
<form action="<c:url value='/updateCustomer'/>" method="post">
    <table border="0" align="center" width="40%" style="margin-left: 100px;">
        <tr>
            <td>
                <input type="text" name="cid" value="${customer.cid}" style="display:none" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <label for="male">男</label>
                    <%--<input type="radio" name="gender" value="女" id="female" ${customer.gender=="女" ? "checked='checked'" : ""}/>--%>
                    <input type="radio" name="gender" value="女" id="female" <c:if test="${customer.gender eq '女'}">checked</c:if>/>
